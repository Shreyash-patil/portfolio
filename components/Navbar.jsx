  ...
  return (
    <>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white/50 backdrop-blur-lg shadow-sm" :""}` }>
        ...
        <ul className={`hidden md:flex items-center gap-6 lg:gap-8 px-12 py-3 bg-white/50  shadow-sm rounded-2xl`}>
          <li>
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href="#contact"
            className='font-serif hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4'
          >
